        ...
        <div className="max-w-6xl w-full flex flex-col gap-10">
          ...
          >
            ...
            <p className="text-[#4c6c9a] dark:text-slate-400 text-lg font-normal leading-relaxed">
              A well-designed logo is the foundation of your brand identity. It
              communicates your values, creates recognition, and builds trust
              with your audience.
            </p>
          </motion.div>
          <motion.div
          ...
          >
            ...
            >
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="text-[#4c6c9a] dark:text-slate-400 text-sm leading-relaxed">
                  Establish a strong visual presence that differentiates your
                  brand from competitors and creates lasting impressions.
                </p>
              </div>
            </motion.div>
            {/* Feature 2 */}
            ...
            >
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="text-[#4c6c9a] dark:text-slate-400 text-sm leading-relaxed">
                  Build trust and credibility with a professional logo that
                  signals quality and reliability to your customers.
                </p>
              </div>
            </motion.div>
            {/* Feature 3 */}
            ...
            >
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="text-[#4c6c9a] dark:text-slate-400 text-sm leading-relaxed">
                  Receive vector files that scale perfectly from business cards
                  to billboards without losing quality.
                </p>
              </div>
            </motion.div>
          </motion.div>
...
export default LogoDesignFeatures
