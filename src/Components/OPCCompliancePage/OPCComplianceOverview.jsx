      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            ...
            returns or annual compliance's for OPC company are needed to be
            filed on an{" "}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12">
            ...
            >
              ...
              <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                Regular filings required on annual, biannual, half-yearly and
                quarterly basis to maintain legal status with MCA.
              </p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-3">
                Event-based Compliance's
              </h3>
              <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                These are compliance that are filed on certain MCA notifications
                and specific business events as they occur.
              </p>
            </motion.div>
          </div>
        </motion.div>
        ...
        >
          <div className="max-w-3xl mx-auto text-center space-y-6">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-400 leading-relaxed">
              ...
              aid of business experts. Therefore, compliance for a OPC company
              should only be filed by these experts.{" "}
              <span className="font-semibold text-slate-900 dark:text-white">
            ...
            >
              <p className="text-slate-600 dark:text-slate-400 leading-relaxed mb-6">
                ...
                services for OPC company in India.
              </p>
...
export default OPCComplianceOverview
