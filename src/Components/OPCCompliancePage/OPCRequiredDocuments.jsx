...
const OPCRequiredDocuments = () => {
  const documents = [
    {
      icon: "badge",
      title: "PAN Card of Directors",
      description:
        "Valid PAN card copies of all directors of the company for identity verification and tax purposes.",
    },
    {
      icon: "person",
      title: "Identity Proof of Directors",
      description:
        "Government-issued identity documents (Aadhar, Passport, Driving License) of all company directors.",
    },
    {
      icon: "description",
      title: "Memorandum of Association",
      description:
        "The MOA document containing company objectives, registered office details, and capital structure.",
    },
    {
      icon: "assignment",
      title: "Articles of Association",
      description:
        "The AOA document outlining rules and regulations for internal management of the company.",
    },
  ]
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
                ...
                verified, and submitted to maintain compliance with MCA
                regulations.
              </p>
            </div>
          </div>
...
export default OPCRequiredDocuments
