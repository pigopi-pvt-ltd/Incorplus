...
import Image from "../../assets/GSTComplianceImage.avif"

const GSTComplianceHero = () => {
  ...
  return (
    <>
          ...
          <div className="lg:w-1/2 space-y-8">
            ...
            >
              ...
              <span className="mt-2 inline-block">
                Expert guidance and seamless filing process to keep your
      ...
      <ConsultationModal
        ...
        selectedPlan={"GST Compliances"}
      />
    </>
  )
}

export default GSTComplianceHero
