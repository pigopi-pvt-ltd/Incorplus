...
const GSTRequiredDocuments = () => {
  const documents = [
    {
      icon: "lock",
      title: "Digital Signature",
      description:
        "Secure digital signature for authenticating and signing GST returns electronically.",
    },
    {
      icon: "verified",
      title: "GST Registration Certificate",
      description:
        "Official GST registration certificate issued by the tax authorities for your business.",
    },
    {
      icon: "password",
      title: "Log-in Credentials of Registered Person",
      description:
        "Login credentials for the registered person to access GST portal and file returns.",
    },
    {
      icon: "inventory_2",
      title: "Details of Supplies",
      description:
        "Comprehensive details of all supplies made and received during the reporting period.",
    },
  ]
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="font-display text-4xl font-bold text-slate-900 dark:text-white">
            Required Documents for GST Compliance
          </h2>
          <motion.div
            initial={{ width: 0 }}
          ...
          <p className="text-lg text-slate-600 dark:text-slate-400 max-w-2xl mx-auto mt-4">
            Essential documents needed for seamless GST compliance filing
          </p>
        </motion.div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
                ...
                process for GST compliance. We ensure all documents are properly
                prepared, verified, and submitted for maintaining compliance
                with all GST regulatory requirements.
              </p>
            </div>
          </div>
        </motion.div>
...
export default GSTRequiredDocuments
