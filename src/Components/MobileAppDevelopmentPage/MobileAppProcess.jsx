        ...
        <div className="max-w-6xl w-full flex flex-col gap-12">
          ...
          >
            ...
            <p className="text-[#4c6c9a] dark:text-slate-400 max-w-2xl">
              A streamlined approach to delivering high-quality mobile
              applications that meet your business objectives and exceed user
              expectations.
            </p>
          </motion.div>
          <motion.div
          ...
          >
            ...
            >
              ...
              <p className="text-sm text-[#4c6c9a] dark:text-slate-400">
                Define goals, target audience, and core features for your app.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-sm text-[#4c6c9a] dark:text-slate-400">
                Create intuitive, user-friendly interfaces and smooth
                interactions.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-sm text-[#4c6c9a] dark:text-slate-400">
                Build your app with cutting-edge technologies and best
                practices.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-sm text-[#4c6c9a] dark:text-slate-400">
                Deploy to app stores and provide ongoing maintenance & updates.
              </p>
            </motion.div>
          </motion.div>
        </div>
