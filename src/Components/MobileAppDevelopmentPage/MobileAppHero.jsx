...
import mobileImage from "../../assets/mobileAppDev.avif"
        ...
        <div className="px-4 md:px-20 lg:px-40 py-12 flex justify-center">
          <div className="max-w-6xl w-full flex flex-col-reverse lg:flex-row gap-12 items-center">
            <div className="flex flex-col gap-6 lg:w-1/2 text-left">
              ...
              >
                From concept to deployment, Incorplus Venture builds stunning,
                high-performance mobile apps that engage users and drive growth
            ...
            >
              <div className="w-full aspect-[4/3] bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-slate-800 dark:to-slate-900 rounded-2xl relative overflow-hidden shadow-2xl border border-slate-200 dark:border-slate-700">
                {/* Mobile App UI Representation */}
                <div
                  className="absolute inset-0 bg-cover bg-center opacity-90"
                  data-alt="Mobile phone showing app interface with clean UI"
                  style={{
