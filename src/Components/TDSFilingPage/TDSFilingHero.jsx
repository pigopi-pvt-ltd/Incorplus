          ...
          <div className="lg:w-1/2 space-y-8">
            ...
            >
              <span className="font-bold text-2xl text-slate-900 dark:text-white">
                TDS Return Filing in just 3 Days.
              </span>
              <br />
              <span className="mt-2 inline-block">
                Fast, accurate, and compliant TDS filing services to keep your
                business on track.
              </span>
            </motion.p>
          ...
          <div className="lg:w-1/2 relative">
            ...
            >
              <motion.img
                ...
                src="https://images.unsplash.com/photo-1554224154-26032ffc0d07?w=800&auto=format&fit=crop&q=80"
              />
