        ...
        <div className="max-w-6xl w-full flex flex-col gap-12">
          ...
          >
            ...
            <p className="text-[#4c6c9a] dark:text-slate-400 max-w-2xl">
              A structured approach to creating impactful graphics that align
              with your brand and communicate your message effectively.
            </p>
          </motion.div>
          <motion.div
          ...
          >
            ...
            >
              ...
              <p className="text-sm text-[#4c6c9a] dark:text-slate-400">
                Understand your goals, target audience, and design requirements.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-sm text-[#4c6c9a] dark:text-slate-400">
                Create initial concepts and mockups based on your brand
                guidelines.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-sm text-[#4c6c9a] dark:text-slate-400">
                Gather feedback and refine designs to perfection.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-sm text-[#4c6c9a] dark:text-slate-400">
                Deliver final designs in all required formats and resolutions.
              </p>
            </motion.div>
          </motion.div>
        </div>
