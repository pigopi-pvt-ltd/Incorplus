...
const Navbar = () => {
  ...
  const navLinkClasses = ({ isActive }) =>
    `px-4 py-2 text-sm font-semibold transition-all rounded-full flex items-center ${
      isActive
  ...
  const mobileLinkClasses = ({ isActive }) =>
    `w-full px-5 py-3 text-base font-bold transition-all rounded-xl flex items-center gap-3 ${
      isActive
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="hidden md:block bg-slate-900 dark:bg-white text-white dark:text-slate-900 hover:bg-blue-600 dark:hover:bg-slate-200 text-sm font-bold px-5 py-2.5 rounded-full transition-all"
            >
              Get Started
            </button>
