      ...
      <div className="relative overflow-hidden pt-12 pb-20 bg-gradient-to-br from-slate-50 to-white dark:from-slate-900 dark:to-slate-800 border-b border-slate-100 dark:border-slate-800">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center gap-12 relative z-10">
          ...
          <div className="lg:w-1/2 space-y-8">
            ...
            >
              Stay updated, compliant, and focused on growth. We ensure your
              Limited Liability Partnership meets all legal benchmarks without
          ...
          <div className="lg:w-1/2 relative">
            ...
            >
              <motion.img
                ...
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuCG4zCmhOMldhFSPmDYyhbQxI_HkrrQ1en_qE0TSP5jr5s6-fDUfiiZE8hMlUvreGlAFFWxqKbcJG90gaOAbrcoKfr0eGkYvH8Y_625Q26R0aSGD1oJr4pHBs5n28JL80pKSk3ZpJMenzTtHKpWiuseOfSd-xTs8g2-nUJGoce2vFwdnlaxt67n-vBghtan5oEU6bB7AHlancusiMbYBlg_Xy8hJ5_lH43CQy_M8HqGh9HpvMdNW43hJS9Bp6PEkDH7kCGZzrFjsFkX"
              />
...
export default LLPComplianceHero
