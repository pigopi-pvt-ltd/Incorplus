...
const AccountingRequiredDocuments = () => {
  const documents = [
    {
      icon: "credit_card",
      title: "PAN Card",
      description:
        "Permanent Account Number (PAN) card for tax identification purposes.",
    },
    {
      icon: "description",
      title: "Incorporation Documents",
      description:
        "Legal documents proving the incorporation of the business entity.",
    },
    {
      icon: "account_balance",
      title: "Bank Statement",
      description:
        "Recent bank statements showing the financial transactions of the business.",
    },
    {
      icon: "verified",
      title: "Registration Certificates",
      description:
        "Certificates of registration for the business with relevant authorities.",
    },
    {
      icon: "receipt_long",
      title: "Invoices and Bills",
      description:
        "Detailed invoices and bills for all business transactions and purchases.",
    },
    {
      icon: "inventory_2",
      title: "Details of Assets",
      description:
        "Comprehensive list and details of all business assets owned by the entity.",
    },
    {
      icon: "toll",
      title: "Preliminary Expense",
      description:
        "Documentation of all preliminary expenses incurred during business setup.",
    },
    {
      icon: "payments",
      title: "Details of Cash Transactions",
      description:
        "Complete records of all cash transactions for proper bookkeeping.",
    },
  ]
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="font-display text-4xl font-bold text-slate-900 dark:text-white">
            Required Documents for Accounting Services
          </h2>
          <motion.div
            initial={{ width: 0 }}
          ...
          <p className="text-lg text-slate-600 dark:text-slate-400 max-w-2xl mx-auto mt-4">
            Essential documents needed for comprehensive accounting and
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
                ...
                process for accounting and bookkeeping services. We ensure all
                documents are properly prepared, verified, and organized for
...
export default AccountingRequiredDocuments
