          ...
          <div className="max-w-6xl w-full flex flex-col-reverse lg:flex-row gap-12 items-center">
            <div className="flex flex-col gap-6 lg:w-1/2 text-left">
              ...
              >
                ...
                Incorplus Venture turns your vision into a pixel-perfect
                reality. Scale your MSME with a robust online presence.
              </motion.h2>
              <motion.div
            ...
            >
              <div className="flex -space-x-2">
                ...
                <div
                  ...
                  style={{
                    backgroundImage:
                      "url('https://lh3.googleusercontent.com/aida-public/AB6AXuBlqxNkdIcKiWRauCW1IBk0EgrZcbUWvAM1H1n6OjdpGtbMupOJFkYF_NaQVnBdGYQzx_7iZ5lVl8Atl_0dfDFeinV4Y9TZrA9D9ydD2NnWQ5tcoFqiBVcVj_agIsCRaN8ceKJIu2wVDr7G_cRnsq-p0MHAORwtgLkeCL-VSmLZD6MvHtXbliQ55PNLuBtsp14zFukar7wN3f-QBTRkDAEfuj5U9140gugMQVGgY8Cy0dtqqQuyqSkZ6KtlYXgOQbfphjHrHdIx2hmr')",
                  }}
                ></div>
                <div
                  className="w-8 h-8 rounded-full bg-gray-300 border-2 border-white dark:border-[#101822] bg-cover bg-center"
                ...
                <div
                  ...
                  style={{
                    backgroundImage:
                      "url('https://lh3.googleusercontent.com/aida-public/AB6AXuCVRkAQxnMV-_VQD4aApW8bFWT7668vTuuSPH2aKbGxWjD3OOvFYIg2zyAMFm_f2dQLQ8Zai8ErLyYy8N4nDDXO0JEWYlnu-0SsGsMzUzsIxZmqhjpaLo-Oeh0J0jk8wW6rRPHtnTWvd2P8lS9pwNQ8lFKtCoqGGL1vRS1GZGzIPunPY7gy5D30_qDP-gVhEGI6Tsu2qui6K2S_oxKVpxZmgxLxAi_FSZoJpahgntpmYTfwPP7v1KbeYRX08P5q0mI6YIG_u69pald5')",
                  }}
                ></div>
              </div>
            ...
            >
              <div className="w-full aspect-[4/3] bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-slate-800 dark:to-slate-900 rounded-2xl relative overflow-hidden shadow-2xl border border-slate-200 dark:border-slate-700">
                {/* Abstract Dashboard UI Representation */}
                <div
                  className="absolute inset-0 bg-cover bg-center opacity-90"
                  data-alt="Laptop screen showing data charts and graphs"
                  style={{
                    backgroundImage:
                      "url('https://lh3.googleusercontent.com/aida-public/AB6AXuDYav1e-ASvLlSC-YrcMSI8XndlsYKAPg5XhUXrv1kLdD0QBrAAD4xZkUYI7L2hYMScCoPPukLgD856ygUtZJkSPokwVn4b4IpK0bg57sO-ZLSAP5BPyzKz-BPnk74gMXqctLondg3qaE3gmY8_iHcWuPOfBtXMVbYfN0uggeFeV2Zx3koffp4MviBWWSxS9axX9ABKB6A2eHzWbfLrKFBureJzk-JDHQXAhTtwjTSKFhcAhnrV6MdbA-idxur6Wtt2hXrPqZPFAvPU')",
                  }}
                ></div>
