        ...
        <div className="max-w-6xl w-full flex flex-col gap-10">
          ...
          >
            ...
            <p className="text-[#4c6c9a] dark:text-slate-400 text-lg font-normal leading-relaxed">
              In today's digital age, a website is your most powerful asset.
              Here is how we help you scale your operations and reach.
            </p>
          </motion.div>
          <motion.div
          ...
          >
            ...
            >
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="text-[#4c6c9a] dark:text-slate-400 text-sm leading-relaxed">
                  Your business never sleeps. Let customers find your products
            ...
            >
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="text-[#4c6c9a] dark:text-slate-400 text-sm leading-relaxed">
                  Establish trust with investors and partners through a
                  professional, secure digital footprint.
                </p>
              </div>
            </motion.div>
            {/* Feature 3 */}
            ...
            >
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="text-[#4c6c9a] dark:text-slate-400 text-sm leading-relaxed">
                  Expand beyond local boundaries and tap into international
