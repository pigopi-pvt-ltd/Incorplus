        ...
        <div className="max-w-6xl w-full flex flex-col gap-12">
          ...
          >
            ...
            <p className="text-[#4c6c9a] dark:text-slate-400 max-w-2xl">
              A transparent, agile process designed to get your MSME online
          ...
          >
            ...
            >
              ...
              <p className="text-sm text-[#4c6c9a] dark:text-slate-400">
                Creating wireframes and visual designs that convert.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-sm text-[#4c6c9a] dark:text-slate-400">
                Clean, semantic coding with the latest tech stack.
              </p>
            </motion.div>
